 ...
 */
$config['site_title']                 = "Bacchus.io";       // Site Title, example.com
$config['admin_email']                = "confirmations@bacchus.io"; // Admin Email, admin@example.com
...
$config['error_start_delimiter']   = '<p><span class="label label-danger">';		// Error mesage start delimiter
