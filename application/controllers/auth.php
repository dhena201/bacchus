...
class Auth extends MY_Controller {
	...
	function __construct() {
		...
		$this->content = 'auth/template_auth';
	...
	function login() {
		...
		if ($this->ion_auth->logged_in() || $this->ion_auth->is_admin()) {
			redirect('/', 'refresh');
			//already logged in or admin
		}
		
		$this->data['title'] = "Login";
		$this->data['content'] = $this->content;
		$this->data['auth_content'] = 'auth/login';
	...
	function change_password() {
		...
		$this->data['content'] = $this->content;
		$this->data['auth_content'] = 'auth/change_password';
		$this->data['navigation'] = $this->navigation;
	...
	function forgot_password() {
		...
		$this->data['content'] = $this->content;
		$this->data['auth_content'] = 'auth/forgot_password';
		$this->data['navigation'] = $this->navigation;
	...
	public function reset_password($code = NULL) {
		...
		$this->data['content'] = $this->content;
		$this->data['auth_content'] = 'auth/reset_password';
		$this->data['navigation'] = $this->navigation;
	...
	function deactivate($id = NULL) {
		...
		$this->data['content'] = $this->content;
		$this->data['auth_content'] = 'auth/deactivate_user';
		$this->data['navigation'] = $this->navigation;
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if ($this->input->post('confirm') == 'yes') {
				...
				if (($this->ion_auth->logged_in() && $this->ion_auth->user()->row()->id == $id) || $this->ion_auth->is_admin()){
	...
	function create_user() {
		...
		$this->data['content'] = $this->content;
		$this->data['auth_content'] = 'auth/create_user';
		$this->data['navigation'] = $this->navigation;
	...
	function edit_user($id) {
		...
		$this->data['content'] = $this->content;
		$this->data['auth_content'] = 'auth/edit_user';
		$this->data['navigation'] = $this->navigation;
	...
	function create_group() {
		...
		$this->data['content'] = $this->content;
		$this->data['auth_content'] = 'auth/create_group';
		$this->data['navigation'] = $this->navigation;
	...
	function edit_group($id) {
		...
		$this->data['content'] = $this->content;
		$this->data['auth_content'] = 'auth/edit_group';
		$this->data['navigation'] = $this->navigation;
